...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Apr 2026 pada 15.39
...
(4, 'The Humans', 'Ketika sesosok alien tiba di Bumi, kesan pertamanya terhadap manusia jauh dari kata positif. Karena itu ia ingin segera menyelesaikan misinya dan melepaskan samarannya sebagai Profesor Andrew Martin, matematikawan terkemuka di Universitas Cambridge. Sebagai bagian dari masyarakat yang sudah mencapai keabadian dan pengetahuan tak terbatas, ia sungguh jijik dengan penampilan manusia, makanan mereka, serta perang yang ia saksikan di berita. Tak hanya itu, konsep absurd seperti cinta dan keluarga benar-benar membuatnya bingung.\r\n\r\nNamun seiring waktu, ia mulai memahami bahwa spesies aneh ini berbeda dari penilaian awalnya. Ia mulai minum anggur, membaca puisi Emily Dickinson, mendengarkan musik Talking Heads, dan perlahan terhubung dengan keluarga Andrew Martin. Ia belajar bahwa rasa sakit, sedih, dan takut adalah bagian dari menjadi manusia serta ada harapan dalam ketidaksempurnaan manusia. Semua ini membuatnya mulai mempertanyakan misi yang membawanya ke Bumi—misi yang bukan hanya bertujuan menghambat kemajuan manusia, tetapi juga melibatkan pembunuhan.\r\n\r\nProlog:\r\nBuku ini, buku nyata ini, berlatar di sini, di Bumi. Buku ini membahas tentang makna kehidupan dan bukan apa-apa sama sekali. Tentang apa yang dibutuhkan untuk membunuh seseorang, dan menyelamatkan mereka. Tentang materi dan antimateri, segalanya dan bukan apa-apa, harapan dan kebencian. Tentang sejarawan perempuan berumur 41 tahun bernama Isobel, anak laki-lakinya yang berumur 15 tahun yang bernama Gulliver, serta matematikawan terpintar sedunia. Singkatnya, ini tentang cara menjadi manusia.\r\n\r\nProfil Penulis:\r\nMatt Haig adalah pengarang novel dan jurnalis berkebangsaan Inggris. Dia menulis buku fiksi dan nonfiksi untuk anak-anak serta dewasa. Dia pernah memenangi penghargaan Blue Peter Award dan the Smarties Book Prize. Karya-karyanya sudah diterjemahkan ke dalam empat puluh bahasa. @matthaig1 @maatzhaig matthaig.com', 'Matt Haig', 'Gramedia Pustaka Utama', 2025, 'th.jpg', 'Fiksi\r\n'),
...
(17, 'Si Juki Anak Kosan Series Vol. 4', 'Seteleh sekian lama, Si Juki kembali lagi dengan kejadian aneh bin ajaib. Mulai dari ngeprank di April Mop, diserang action figur, Masamie yang jadi langka, sampai harus bikin permintaan ke Jin. Begitulah hari-hari yang dilalui Juki bersama teman-teman di kosan. Cerita di dalam buku ini enggak nyambung satu sama lainnya, jadi bisa baca mulai dari bagian mana pun. Nah, sekarang kenapa diam aja sambil baca ini ? Langsung bawa buku ini dan bayar di kasir !\r\n\r\n***\r\n\r\nPernahkah Anda terpikir betapa menariknya dunia yang terbuka lebar lewat lembaran buku? Membaca bukan hanya kegiatan rutin, tetapi juga petualangan tak terbatas ke dalam imajinasi dan pengetahuan.\r\n\r\nMembaca mengasah pikiran, membuka wawasan, dan memperkaya kosakata. Ini adalah pintu menuju dunia di luar kita yang tak terbatas.\r\n\r\nTetapkan waktu khusus untuk membaca setiap hari. Dari membaca sebelum tidur hingga menyempatkan waktu di pagi hari, kebiasaan membaca dapat dibentuk dengan konsistensi.\r\n\r\nPilih buku sesuai minat dan level literasi. Mulailah dengan buku yang sesuai dengan keinginan dan kemampuan membaca.\r\n\r\nTemukan tempat yang tenang dan nyaman untuk membaca. Lampu yang cukup, kursi yang nyaman, dan sedikit musik pelataran bisa menciptakan pengalaman membaca yang lebih baik.\r\n\r\nBuat catatan atau jurnal tentang buku yang telah Anda baca. Tuliskan pemikiran, kesan, dan pelajaran yang Anda dapatkan.', 'Faza Meonk', 'Falcon Publishing', 2025, '67b6e3296e4720.65893245.jpg', 'Komik');
...
--
-- Dumping data untuk tabel `favorit_buku`
--

INSERT INTO `favorit_buku` (`ID`, `UserID`, `BukuID`) VALUES
(6, 14, 0),
(2, 14, 3),
(3, 14, 4),
(4, 14, 5),
...
INSERT INTO `peminjaman` (`PeminjamanID`, `UserID`, `BukuID`, `TanggalPeminjaman`, `TanggalPengembalian`, `Status`) VALUES
(21, 15, 6, '2025-02-20', '2025-02-27', 'Dikembalikan'),
(22, 14, 3, '2025-02-20', '2025-02-27', 'Dikembalikan'),
(23, 14, 3, '2026-04-16', '2026-04-23', 'Dipinjam');
...
(1, 8, 3, 'Bukunya Menarikk', 5),
(4, 14, 3, 'baik', 5),
(5, 14, 5, 'bagus banget\r\n', 5),
(16, 15, 7, 'bagus', 5),
(20, 14, 3, 'Bukunya bagus', 5);
...
(9, 'petugas', '$2y$10$a2HCq0y99cH26NTpU9mpluH.NwW0HagWh25mvudx5faBnl8JBtEXe', 'eak@gmail.com', 'yeye', 'tuban', 'petugas', 'aktif', 'pt.png'),
...
(15, 'gopal', '$2y$10$GDWRj.yJlbZzBygbKKCVIe8N.2xSoQR3rzCZMgHKUUbQj0vZJ.DmO', 'sss@gmail.com', 'Gopal', 'gfjytjutg', 'peminjam', 'diblokir', 'us.png');
...
--
ALTER TABLE `ulasanbuku`
  MODIFY `UlasanID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
