...
<head>
    ...
    <title>Daftar Peminjam - Perpustakaan Digital</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="user.php" class="active"><i class="fas fa-users"></i> Pengguna</a>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            // Menentukan status
                            $statusClass = $row['status'] == 'Aktif' ? 'status-aktif' : 'status-diblokir';
                            ...
                            if ($row['status'] == 'Aktif') {
                                echo "<a href='blokir_user.php?id=" . $row['UserID'] . "' class='btn btn-blokir'>Blokir</a>";
                                echo "<a href='aktifkan_user.php?id=" . $row['UserID'] . "' class='btn btn-aktifkan'>Aktifkan</a>";
                            } else {
                                echo "<a href='aktifkan_user.php?id=" . $row['UserID'] . "' class='btn btn-aktifkan'>Aktifkan</a>";
                                echo "<a href='blokir_user.php?id=" . $row['UserID'] . "' class='btn btn-blokir'>Blokir</a>";
                            }
